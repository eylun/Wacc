...
class LexerSpec extends AnyFlatSpec {
    ...
    //     assertResultEquals(
    //       Success(IntLiterNode(12345)(_)),
    //       lexer.intLiter.parse("+12345")
    //     )
    //     assertResultEquals(
    //       Success(IntLiterNode(-1232)(_)),
    ...
    //     assertResultEquals(
    //       Success(IntLiterNode(42)(_)),
    //       lexer.intLiter.parse("42")
    //     )
    //     assertResultEquals(
    //       Success(IntLiterNode(868)(_)),
    ...
    //     assertResultEquals(
    //       Success(CharLiterNode('c')(_)),
    //       lexer.charLiter.parse("'c'")
    //     )
    //     assertResultEquals(
    //       Success(CharLiterNode('\u0000')(_)),
    ...
    //     assertResultEquals(
    //       Success(IdentNode("camelCaseIdent")(_)),
    //       lexer.identifier.parse("camelCaseIdent")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("_underscorewithlowercase")(_)),
    //       lexer.identifier.parse("_underscorewithlowercase")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("_underscoreWithCamelCase")(_)),
    //       lexer.identifier.parse("_underscoreWithCamelCase")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("UppercaseIdent")(_)),
    //       lexer.identifier.parse("UppercaseIdent")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("CONST_IDENT")(_)),
    //       lexer.identifier.parse("CONST_IDENT")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("_09")(_)),
    //       lexer.identifier.parse("_09")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("snake_case")(_)),
    //       lexer.identifier.parse("snake_case")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("combinedIdent_with_Nums_230")(_)),
    //       lexer.identifier.parse("combinedIdent_with_Nums_230")
    //     )
    //     assertResultEquals(
    //       Success(IdentNode("_____")(_)),
